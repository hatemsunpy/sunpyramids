...
const handlers = {
  'route': () => {
    ...
    if (process.env.CLAUDE_FLOW_V3_ENABLED !== 'false' && process.env.CLAUDE_FLOW_HOOKS_ENABLED !== 'false' && intelligence && intelligence.getContext) {
      try {
  ...
  'session-restore': async () => {
    ...
    if (process.env.CLAUDE_FLOW_V3_ENABLED !== 'false' && process.env.CLAUDE_FLOW_HOOKS_ENABLED !== 'false' && intelligence && intelligence.init) {
  ...
  'session-end': async () => {
    ...
    if (process.env.CLAUDE_FLOW_V3_ENABLED !== 'false' && process.env.CLAUDE_FLOW_HOOKS_ENABLED !== 'false' && intelligence && intelligence.consolidate) {
